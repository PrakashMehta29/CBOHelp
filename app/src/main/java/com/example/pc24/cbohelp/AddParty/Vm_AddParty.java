...
import com.example.pc24.cbohelp.PartyView.Vm_Party;
...
public class Vm_AddParty  extends ViewModel{
    ...
    Vm_Party.OnResultlistener resultlistener;
    ...
    public  void GetAllParty(Context context, Vm_Party.OnResultlistener resultlistener){
    ...
    public void GetData(Activity context, Vm_Party.OnResultlistener Listener){
